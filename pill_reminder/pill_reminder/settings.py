...
SECRET_KEY = 'django-insecure-s(a##a&1yhyko#o%8r11i*9i6-8+ag%zgg(=qihouzfe)@z0jb'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'reminder' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    BASE_DIR / "reminder/static",  # Adjust this path based on your project structure
]
